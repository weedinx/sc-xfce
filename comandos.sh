...
sudo apt --no-install-recommends install -y keyboard-configuration xiccd xinit xinput xkb-data xml-core xorg-docs-core xorg xserver-common xserver-xorg-core xserver-xorg-input-all xserver-xorg-input-libinput xserver-xorg-input-synaptics xserver-xorg-input-wacom xserver-xorg-legacy xserver-xorg-video-all xserver-xorg-video-amdgpu xserver-xorg-video-ati xserver-xorg-video-fbdev xserver-xorg-video-intel xserver-xorg-video-nouveau xserver-xorg-video-qxl xserver-xorg-video-radeon xserver-xorg-video-vesa xserver-xorg-video-vmware
sudo apt --no-install-recommends install -y software-properties-common software-properties-gtk sound-theme-freedesktop pulseaudio-utils pulseaudio cups system-config-printer printer-driver-gutenprint printer-driver-escpr cups-client hplip -y
sudo apt --no-install-recommends install -yubuntu-advantage-desktop-daemon ubuntu-advantage-tools ubuntu-drivers-common ubuntu-keyring ubuntu-minimal ubuntu-release-upgrader-core ubuntu-standard
...
sudo apt install -y curl zip unzip git htop xfce4-whiskermenu-plugin viewnior cpu-x gpick yaru-theme-gtk yaru-theme-icon pavucontrol
sudo apt install -y bluez pulseaudio-module-bluetooth thunderbird qbittorrent vlc atril blueman
sudo apt install -y language-pack-gnome-pt-base language-pack-gnome-pt language-pack-pt-base language-pack-pt language-selector-commo
sudo apt --no-install-recommends install -yubuntu-advantage-desktop-daemon ubuntu-advantage-tools ubuntu-drivers-common ubuntu-keyring ubuntu-minimal ubuntu-release-upgrader-core ubuntu-standard util-linux-extra util-linux
